...
class SMTools:
    ...
    def check_progress(self, action_id, timeout, action):
        ...
        try:
            wait_time = CONFIGSM['wait_between_events_check']
        except:
            wait_time = 30
            self.minor_error("Please set value for wait_between_events_check")
